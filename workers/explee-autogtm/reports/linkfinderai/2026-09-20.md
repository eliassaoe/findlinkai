# Explee follow-ups — linkfinderai — 2026-09-20 06:44 UTC
...
| nudge | 5 |
| skip: booked | 4 |
| skip: nudge 1 due in 0.3d | 3 |
| skip: nudge 1 due in 0.1d | 1 |
| skip: nudge 2 due in 2.1d | 1 |
| skip: question | 1 |
...
|---|---|---|---|
| Pedro (AMORE Global) | High ticket linkfinder AI | Bonjour Ellen,   Oui ça m'intéresse.   Merci | would send nudge |
| Eric (Crawler Agency) | High ticket linkfinder AI | Bonjour Sun,  Merci pour votre e-mail Votre approche pourrait m’intéresser mais comment p… | would send nudge |
| Thino (Surf Web Development) | High ticket linkfinder AI | Bonjour Brad,  Merci à vous de m’avoir contacté.  Puis-je en savoir plus sur votre tarif … | would send nudge |
| Fabrice (FinDiT Consulting) | High ticket linkfinder AI | Bonjour  Nous n’accompagnons pas les FinTech mais les institution financières (banque / f… | would send nudge |
| Michael (WANT:HEAD) | High ticket linkfinder AI | Hello Bryce,   On peut en discuter oui !     Vendredi après-midi ?                       … | would send nudge |

## Everyone else who replied

| who | campaign | they said | status |
|---|---|---|---|
| davidkia (DK Origins) | High ticket linkfinder AI | Bonjour Benjamin,   Merci pour vos messages. Je vous avoue être submergé par des proposit… | 2026-09-20 |
| Ibrahim (Skillhubs) | High ticket linkfinder AI | Bonjour Avez-vous un numéro de téléphone ? De quelle société appelez-vous ?  IA  Envoyé à… | 2026-09-20 |
| Daniel (EMDS CONSEIL) | High ticket linkfinder AI | Bonjour monsieur,  Adressez-moi plus d’informations sur votre fonctionnement.  Merci bien… | 2026-09-20 |
| Hugo (AntheDesign) | High ticket linkfinder AI | ?   		[Hugo ESSIQUE]  		Hugo ESSIQUE  		CEO / Chef de projet  		[Logo] [https://www.anthe… | 2026-09-20 |
