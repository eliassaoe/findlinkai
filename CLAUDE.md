...
| **Building our own GTM agent** (Explee search + our copy AI + Instantly sending) | `docs/own-gtm-agent-plan.md` — the economics, the 135/day capacity ceiling, and why leads are not the bottleneck |
