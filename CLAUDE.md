...
| Self-hosting an agentic outreach pipeline (gtm-mcp, Apollo->LinkFinder, SmartLead->Instantly) | `docs/gtm-mcp-swap-map.md` — read the credit-cost discrepancy in it before trusting any cost estimate |
